...
class Strategy {
    ...
    private:
        ...
        struct DefenceConfig {
            ...
            static constexpr float RETURN_GAIN = 3.0f; // RPM per mm
            static constexpr float RETURN_MAX_SPD = 270.0f;
            static constexpr float RETURN_MIN_SPD = 100.0f;
            static constexpr float BOX_CORRECTION_GAIN = 1.2f; // RPM per mm outside inset
            static constexpr float BOX_CORRECTION_MIN_SPD = 35.0f;
            static constexpr float SHUFFLE_GAIN = 3.0f; // RPM per degree outside deadband
